    ...
    <div class="row align-items-center justify-content-between">
      <div class="col-auto">
        <div class="d-flex flex-wrap align-items-center gap-4">
          <button type="button" class="sidebar-toggle d-none d-lg-flex" @click="toggleSidebarDesktop">
            <iconify-icon :icon="isSidebarActive ? 'iconoir:arrow-right' : 'heroicons:bars-3-solid'"
              class="icon text-2xl"></iconify-icon>
          </button>

          <button type="button" @click="toggleSidebarMobile" class="sidebar-mobile-toggle d-inline-flex d-lg-none">
              ...
              <ul class="to-top-list">
                <li>
                  <Link
                    ...
                    href="/view-profile">
                    <iconify-icon icon="solar:user-linear" class="icon text-xl"></iconify-icon> My Profile</Link>
                </li>
                <li>
                  <Link
                    class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3"
                    href="/email">
                    <iconify-icon icon="tabler:message-check" class="icon text-xl"></iconify-icon> Inbox</Link>
                </li>
                <li>
                  <Link
                    class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3"
...
<script setup>
import { ref } from 'vue'
import { useTheme } from '@/plugins/useTheme.js'
